...
import type { Conversation, FatwaSource, FeedbackType } from "../types/fatwa";
...
export default function HomeScreen({ navigation }: Props) {
  ...
  const handleSelectConversation = async (conv: Conversation) => {
    ...
    try {
      ...
      setMessages([
        { id: makeId(), role: "error", text: "Sohbet geçmişi yüklenemedi, tekrar dene." },
      ]);
    } finally {
    ...
    <View style={styles.root}>
      ...
      <View style={styles.topBar}>
        <View style={styles.brandRow}>
          <Pressable onPress={() => setMenuOpen((v) => !v)} hitSlop={10} style={styles.iconButton}>
        ...
        <>
          ...
          <View style={styles.menuPanel}>
            ...
            {loadingConversations ? (
              ...
              <Text style={styles.menuEmptyText}>Henüz bir sohbetin yok.</Text>
            ) : (
              <FlatList
                data={conversations}
                keyExtractor={(c) => c.id}
                ...
                renderItem={({ item }) => (
                  ...
                  >
                    <Ionicons
                      ...
                      size={16}
                      color={item.id === conversationId ? colors.gold : colors.muted}
                    />
        ...
        <View style={styles.body}>
          {loadingHistory ? (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyTitle}>Hoş geldin{"\n"}Allah'ın dostu, şeytanın düşmanı</Text>
...
const styles = StyleSheet.create({
  ...
  newChatRow: { flexDirection: "row", alignItems: "center", gap: 10, paddingVertical: 8, paddingHorizontal: 4 },
  newChatIcon: {
    width: 26,
    height: 26,
    borderRadius: 13,
  ...
  menuDivider: { height: 1, backgroundColor: "rgba(212,168,83,0.15)", marginVertical: 8 },
  menuLoading: { paddingVertical: 20, alignItems: "center" },
  menuEmptyText: { color: colors.muted, fontSize: 13, textAlign: "center", paddingVertical: 16 },
  ...
  conversationRowActive: { backgroundColor: "rgba(212,168,83,0.1)" },
  conversationTextWrap: { flex: 1 },
  conversationTitle: { color: colors.cream, fontSize: 13, fontWeight: "600" },
  conversationDate: { color: colors.muted, fontSize: 11, marginTop: 2 },
